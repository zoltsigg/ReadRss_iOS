...
- (UIButton *)leftBtn {
    if(!_leftBtn) {
        ...
        _leftBtn.center = CGPointMake(22, kIphoneNavigationBarHeight/2 + kIphoneStatusBarHeight);
        [_leftBtn setImage:[UIImage imageNamed:@"hamburger"] forState:UIControlStateNormal];
...
- (UIButton *)rightBtn {
    if(!_rightBtn) {
        ...
        _rightBtn.center = CGPointMake(ScreenWidth - 22, kIphoneNavigationBarHeight/2 + kIphoneStatusBarHeight);
