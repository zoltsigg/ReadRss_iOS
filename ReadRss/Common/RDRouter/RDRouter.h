...
extern NSString *const RouterParameterURL;
extern NSString *const RouterParameterCompletion;
extern NSString *const RouterParameterUserInfo;

/**
 *  routerParameters 里内置的几个参数会用到上面定义的 string
 */
typedef void (^RouterHandler)(NSDictionary *routerParameters);

/**
 *  需要返回一个 object，配合 objectForURL: 使用
 */
typedef id (^RouterObjectHandler)(NSDictionary *routerParameters);
